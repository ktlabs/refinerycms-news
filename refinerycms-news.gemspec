Gem::Specification.new do |s|
  ...
  s.files             = [
    ...
    'app/controllers/admin/feed_sources_controller.rb',
    ...
    'app/views/admin/feed_sources',
    'app/views/admin/feed_sources/_feed_source.html.erb',
    'app/views/admin/feed_sources/_form.html.erb',
    'app/views/admin/feed_sources/_locale_picker.html.erb',
